        ...
        for x in tqdm(range(0, width-t, step)):
            ...
            for y in range(0, height-t, step):
                ...
                if not isinstance(patch_img, type(None)):
                    ...
                    prediction[x:x+t, y:y+t] = patch_img
                    print('Imagem do tipo (x, 0)')

        prediction = Image.fromarray(prediction)
        prediction.save(os.path.join('/home/anderson/Documentos/Roney/Código/ortosaida/SextaVersao/', f'{filename_orto}.jpg'))
