...
def main():
    folder_dataset = '/home/anderson/Documentos/Roney/Dataset/Dataset/dataset_mamona'

    path_dataset = os.listdir(folder_dataset)
    path_labels = os.listdir(os.path.join(folder_dataset,[i for i in path_dataset if 'labels' in i][0]))
    ortos = []
    original_names = []
    ...
    for i in range(len(ortos_train)):
        ...
        for j in range(len(original_names)):
            ...
            if ortos_train[i] == unir_vetor((original_names[j][:-2])):
                cont_train+=1
                shutil.copy(folder_dataset+'/labels/'+path_labels[j], '/home/anderson/Documentos/Roney/Dataset/split_dataset/mamona/train/labels/')
                shutil.copy(folder_dataset+'/rgb/'+path_labels[j][:-3]+'jpg', '/home/anderson/Documentos/Roney/Dataset/split_dataset/mamona/train/rgb/')
    ...
    for i in range(len(ortos_val)):
        ...
        for j in range(len(original_names)):
            ...
            if ortos_val[i] == unir_vetor((original_names[j][:-2])):
                cont_val+=1
                shutil.copy(folder_dataset+'/labels/'+path_labels[j], '/home/anderson/Documentos/Roney/Dataset/split_dataset/mamona/val/labels/')
                shutil.copy(folder_dataset+'/rgb/'+path_labels[j][:-3]+'jpg', '/home/anderson/Documentos/Roney/Dataset/split_dataset/mamona/val/rgb/')
    ...
    for i in range(len(ortos_test)):
        ...
        for j in range(len(original_names)):
            ...
            if ortos_test[i] == unir_vetor((original_names[j][:-2])):
                print('oi')
                cont_test+=1
                shutil.copy(folder_dataset+'/labels/'+path_labels[j], '/home/anderson/Documentos/Roney/Dataset/split_dataset/mamona/test/labels/')
                shutil.copy(folder_dataset+'/rgb/'+path_labels[j][:-3]+'jpg', '/home/anderson/Documentos/Roney/Dataset/split_dataset/mamona/test/rgb/')
